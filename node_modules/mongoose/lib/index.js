...
/**
 * Expose connection states for customer-land
 *
 */
 ...
 *
 *     // with mongodb:// URI
 *     db = mongoose.createConnection('mongodb://customer:pass@localhost:port/database');
 *
 *     // and options
 *     var opts = { db: { native_parser: true }}
 *     db = mongoose.createConnection('mongodb://customer:pass@localhost:port/database', opts);
 *
 *     // replica sets
 *     db = mongoose.createConnection('mongodb://customer:pass@localhost:port,anotherhost:port,yetanother:port/database');
 *
 *     // and options
 *     var opts = { replset: { strategy: 'ping', rs_name: 'testSet' }}
 *     db = mongoose.createConnection('mongodb://customer:pass@localhost:port,anotherhost:port,yetanother:port/database', opts);
 *
 *     // with [host, database_name[, port] signature
 *     db = mongoose.createConnection('localhost', 'database', port)
 *
 *     // and options
 *     var opts = { server: { auto_reconnect: false }, customer: 'username', pass: 'mypassword' }
 ...
 * ####Example:
 *
 *     mongoose.connect('mongodb://customer:pass@localhost:port/database');
 *
 *     // replica sets
 *     var uri = 'mongodb://customer:pass@localhost:port,anotherhost:port,yetanother:port/mydatabase';
