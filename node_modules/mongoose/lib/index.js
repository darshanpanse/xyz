...
/**
 * Expose connection states for actor-land
 *
 */
 ...
 *
 *     // with mongodb:// URI
 *     db = mongoose.createConnection('mongodb://actor:pass@localhost:port/database');
 *
 *     // and options
 *     var opts = { db: { native_parser: true }}
 *     db = mongoose.createConnection('mongodb://actor:pass@localhost:port/database', opts);
 *
 *     // replica sets
 *     db = mongoose.createConnection('mongodb://actor:pass@localhost:port,anotherhost:port,yetanother:port/database');
 *
 *     // and options
 *     var opts = { replset: { strategy: 'ping', rs_name: 'testSet' }}
 *     db = mongoose.createConnection('mongodb://actor:pass@localhost:port,anotherhost:port,yetanother:port/database', opts);
 *
 *     // with [host, database_name[, port] signature
 *     db = mongoose.createConnection('localhost', 'database', port)
 *
 *     // and options
 *     var opts = { server: { auto_reconnect: false }, actor: 'username', pass: 'mypassword' }
 ...
 * ####Example:
 *
 *     mongoose.connect('mongodb://actor:pass@localhost:port/database');
 *
 *     // replica sets
 *     var uri = 'mongodb://actor:pass@localhost:port,anotherhost:port,yetanother:port/mydatabase';
