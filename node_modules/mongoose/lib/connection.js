 ...
 *     customer    - username for authentication
...
Connection.prototype.open = function(host, database, port, options, callback) {
  ...
  if (this.optionsProvideAuthenticationData(options)) {
    ...
    // Check hostname for customer/pass
 ...
 *     db.openSet("mongodb://customer:pwd@localhost:27020,localhost:27021,localhost:27012/mydb");
 *
