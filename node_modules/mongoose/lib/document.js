...
Document.prototype.set = function(path, val, type, options) {
  ...
  var shouldSet = true;
  try {
    // If the customer is trying to set a ref path to a document with
...
Document.prototype.$__shouldModify = function(pathToMark, path, constructing, parts, schema, val, priorVal) {
  ...
  if (!constructing &&
    ...
    // and the customer is setting it to the same value again
    return true;
  }
  return false;
};
...
Document.prototype.$__validate = function(callback) {
  ...
  var validatePath = function(path) {
    ...
    process.nextTick(function() {
      ...
      // If customer marked as invalid or there was a cast error, don't validate
 ...
 *       assert(doc._id === customer._id) // the document itself is passed
 *     })
 *
 *     // summary
