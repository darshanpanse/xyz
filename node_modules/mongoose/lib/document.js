...
Document.prototype.set = function(path, val, type, options) {
  ...
  var shouldSet = true;
  try {
    // If the actor is trying to set a ref path to a document with
...
Document.prototype.$__shouldModify = function(pathToMark, path, constructing, parts, schema, val, priorVal) {
  ...
  if (!constructing &&
    ...
    // and the actor is setting it to the same value again
    return true;
  }
  return false;
};
...
Document.prototype.$__validate = function(callback) {
  ...
  var validatePath = function(path) {
    ...
    process.nextTick(function() {
      ...
      // If actor marked as invalid or there was a cast error, don't validate
 ...
 *       options: opts
 *     }, function (err, actor) {
 *       assert(doc._id === actor._id) // the document itself is passed
 *     })
 *
 *     // summary
