 ...
 *
 * Suppose you are implementing customer registration for a website. Users provide an email and password, which gets saved to mongodb. The email is a string that you will want to normalize to lower case, in order to avoid one email having more than one account -- e.g., otherwise, avenue@q.com can be registered for 2 accounts via avenue@q.com and AvEnUe@Q.CoM.
 *
 ...
 *
 *     var customer = new User({email: 'AVENUE@Q.COM'})
 *     console.log(customer.email); // 'avenue@q.com'
 *
 *     // or
 *     var customer = new User
 *     customer.email = 'Avenue@Q.com'
 *     console.log(customer.email) // 'avenue@q.com'
 *
 ...
 *
 * Suppose you are storing credit card numbers and you want to hide everything except the last 4 digits to the mongoose customer. You can do so by defining a getter in the following way:
 *
...
SchemaType.prototype.validate = function(obj, message, type) {
  if (typeof obj === 'function' || obj && utils.getFunctionName(obj.constructor) === 'RegExp') {
    ...
    if (message instanceof Object && !type) {
      ...
      properties.type = properties.type || 'customer defined';
    } else {
      if (!message) {
        message = MongooseError.messages.general.default;
      }
      if (!type) {
        type = 'customer defined';
      }
