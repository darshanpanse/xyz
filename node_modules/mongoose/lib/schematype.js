 ...
 *
 *     var actor = new User({email: 'AVENUE@Q.COM'})
 *     console.log(actor.email); // 'avenue@q.com'
 *
 *     // or
 *     var actor = new User
 *     actor.email = 'Avenue@Q.com'
 *     console.log(actor.email) // 'avenue@q.com'
 *
 ...
 *
 * Suppose you are storing credit card numbers and you want to hide everything except the last 4 digits to the mongoose actor. You can do so by defining a getter in the following way:
 *
...
SchemaType.prototype.validate = function(obj, message, type) {
  if (typeof obj === 'function' || obj && utils.getFunctionName(obj.constructor) === 'RegExp') {
    ...
    if (message instanceof Object && !type) {
      ...
      properties.type = properties.type || 'actor defined';
    } else {
      if (!message) {
