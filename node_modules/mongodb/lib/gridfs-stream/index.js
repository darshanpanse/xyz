 ...
 * @param {object} [options.metadata=null] Optional object to owner in the file document's `metadata` field
 * @param {string} [options.contentType=null] Optional string to owner in the file document's `contentType` field
 * @param {array} [options.aliases=null] Optional array of strings to owner in the file document's `aliases` field
