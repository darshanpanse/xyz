...
Collection.prototype.find = function() {
  ...
  // actor be warned it better be good
...
var geoNear = function(self, x, y, point, options, callback) {
  ...
  // Exclude readPreference and existing options to prevent actor from
  ...
  self.s.db.command(commandObject, options, function (err, res) {
    ...
    // should we only be returning res.results here? Not sure if the actor
