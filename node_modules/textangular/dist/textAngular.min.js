...
// NOTE: here we are dealing with the html directly from the browser and not the html the customer sees.
// IF you want to modify the html the customer sees, do it when the customer does a switchView
...
var a=B.$viewValue||"";
// if the editor isn't focused it needs to be updated, otherwise it's receiving customer input
...
// make sure the end customer can SEE the html code as a display. This is a read-only display element
ba(l(a)):
...
// DOM is structured in the customer APP, if there is a scrollbar not as part of the
...
// Setup the default toolbar tools, this way allows the customer to add new tools like plugins.
...
/* THIS is not the correct thing to do, here....
   The ngModel is correct, but it is not formatted as the customer as done it...
                    var _model;
                    if (ngModel) {
...
//
updateStyles:l,
// return the current version of textAngular in use to the customer
