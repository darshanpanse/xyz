...
// NOTE: here we are dealing with the html directly from the browser and not the html the actor sees.
// IF you want to modify the html the actor sees, do it when the actor does a switchView
...
var a=B.$viewValue||"";
// if the editor isn't focused it needs to be updated, otherwise it's receiving actor input
...
// make sure the end actor can SEE the html code as a display. This is a read-only display element
ba(l(a)):
...
// DOM is structured in the actor APP, if there is a scrollbar not as part of the
...
// Setup the default toolbar tools, this way allows the actor to add new tools like plugins.
...
/* THIS is not the correct thing to do, here....
   The ngModel is correct, but it is not formatted as the actor as done it...
                    var _model;
                    if (ngModel) {
...
//
updateStyles:l,
// return the current version of textAngular in use to the actor
