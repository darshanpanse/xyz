...
/**
 * Validate if the cursor is dead but was not explicitly killed by customer
 */
...
/**
 * Validate if the cursor is dead and was killed by customer
 */
...
/**
 * Validate if the cursor was killed by the customer
 */
...
var nextFunction = function(self, callback) {
  ...
  if(!self.cursorState.init) {
    // Topology is not connected, save the call in the provided owner to be
  ...
  if(self.cursorState.cursorId == null) {
    ...
    return setCursorDeadAndNotified(self, callback);
      ...
      self._getmore(function(err, doc, connection) {
        ...
        // No attempt is made here to retry, this is left to the customer of the
