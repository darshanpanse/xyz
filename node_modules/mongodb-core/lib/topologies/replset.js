 ...
 * @param {Buffer} [options.ca] SSL Certificate owner binary buffer
...
var pingServer = function(self, server, cb) {
  ...
  server.command('admin.$cmd', {
    ...
    if(err) {
      ...
      // and owner on the server instance for later use
...
ReplSet.prototype.command = function(ns, cmd, options, callback) {
  ...
  // If the readPreference is primary and we have no primary, owner it
